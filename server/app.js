...
/**
 * Read manifest.json files from config folder.
 * Manifest files are used for versioning of the static .js, .css files.
 * These files are automatically generated by running gulp build.
 */
[
  {
    key: 'app',
